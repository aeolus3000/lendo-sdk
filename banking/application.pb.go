...
func (x *Application) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *Application) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
var file_application_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x07, 0x62, 0x61, 0x6e, 0x6b, 0x69, 0x6e, 0x67, 0x22, 0x88, 0x01, 0x0a,
	...
	0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x42, 0x0a, 0x5a, 0x08, 0x2f, 0x62, 0x61, 0x6e, 0x6b,
...
var file_application_proto_goTypes = []interface{}{
	(*Application)(nil), // 0: banking.Application
}
